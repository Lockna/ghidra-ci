...
async function main() {
    ...
    generatedMarkdown += `Commit range: [${commitFrom}..${commitTo}](https://github.com/Lockna/ghidra/compare/${commitFrom}...${commitTo})\n\n`;
...
function formatCommit(change, isChild) {
    ...
    const linkSha = `[${change.sha.slice(0, 8)}](https://github.com/Lockna/ghidra/commit/${change.sha})`
